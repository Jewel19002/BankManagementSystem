...
import java.util.*; //random no generate
...
public class SignupOne extends JFrame implements ActionListener
{
    ...
    SignupOne(){
        ...
        //System.out.println(Math.abs((ran.nextLong() % 9000L) + 1000L)); //For four Digit random no genarate
        ...
        male = new JRadioButton("Male"); //for male radio button
        male.setBounds(300,290,60,30);
        male.setBackground(Color.WHITE);
        add(male);
        
        female = new JRadioButton("Female");//foR FEMALE RADIO BUTTON
        ...
        married = new JRadioButton("Married"); //for radio button
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String formno = "" +random;  //formno is long value thats why we convert formno string
        String name = nameTextField.getText(); //get value from name text field
